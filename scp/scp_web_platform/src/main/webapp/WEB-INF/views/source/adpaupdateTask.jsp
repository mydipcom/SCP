		...
		<div class="navbar navbar-default">
			...
			<div class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="${ctx}/source/adapterTask">Source Manage</a></li>
			...
			<div class="col-md-10">
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="alert alert-info" id="showTitle" style="margin-bottom:0px;">Add Task</div>
					</div>
					<div class="panel-body" style="min-height: 390px;">
						<form:form action="${ctx}/source/savatask"  class="form-horizontal"  modelAttribute="source"  method="post"  id="sourceForm">
						...
						<div class="form-group">
								...
								<div class="col-sm-10" id="radio-type">
									<c:choose>
										<c:when test="${source.triggerType eq 1}">
									...
									<c:choose>
										<c:when test="${source.triggerType eq 2}">
									...
									<c:choose>
										<c:when test="${source.triggerType eq 3}">
							...
							<div class="form-group task-time" style="display:none;" id="start-time">
								<div class="col-sm-offset-2 col-sm-10">
									...
									<div class="col-sm-9">
										<input type="text" name="startTime" value="${source.startTime}" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',readOnly:'true'})" class="Wdate validate[required] form-control" style="height:34px;"/>
									</div>
								</div>
							</div>
...
<!-- 							</div> -->
							<div class="form-group task-time start-week"  style="display:none;">
								<div class="col-sm-offset-2 col-sm-10">
									<label class="checkbox-inline">
										<c:choose>
											<c:when test="${source.weekday eq 7}">
									...
									<label class="checkbox-inline">
										<c:choose>
											<c:when test="${source.weekday eq 1}">
									...
									<label class="checkbox-inline"> 
										<c:choose>
											<c:when test="${source.weekday eq 2}">
									...
									<label class="checkbox-inline">
										<c:choose>
											<c:when test="${source.weekday eq 3}">
									...
									<label class="checkbox-inline">
										<c:choose>
											<c:when test="${source.weekday eq 4}">
									...
									<label class="checkbox-inline">
										<c:choose>
											<c:when test="${source.weekday eq 5}">
									...
									<label class="checkbox-inline">
										<c:choose>
											<c:when test="${source.weekday eq 6}">
							...
							<div class="form-group">
								...
								<!--<button type="button" class="btn btn-info"  onclick="back();">Back</button>  -->	
									<button type="button" class="btn btn-info"  onclick="location='${ctx}/source/adapterTask'">Back</button>
								</div>
							</div>
							</form:form>
						</div>
	...
	<script type="text/javascript">
    	function back(){
    		location.href="${ctx}/source/adapterTask";
		}
    	
    	$("#sourceForm").validationEngine({
    		...
    		onAjaxFormComplete : function(errorInForm, form, json,options){
    			...
    			if (e.msg == "success") {
    				alert('save success！');
    				window.location.href = ctx+"/source/adapterTask";
    			} else if(e.msg == "empty"){
