...
/**
 * Replicated joins aggregate algorithm
 * @author ellis.xie
 * @version 1.0
 */

@AlgorithmInfoAnnotation(name="ReplicatedJoinAggregateAlgorithm", algorithmType=AlgorithmType.BasicAlgothm, description="ReplicatedJoinAggregate aggregate algorithm")

public class ReplicatedJoinAggregateAlgorithm extends AggregateAlgorithm {
